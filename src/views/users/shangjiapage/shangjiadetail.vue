    ...
    <div class="main">
      <div class="shangjiainfo">
        ...
        <span
          ...
          "
        >
          <label style="display: inline-block; color: #909399; font-size: 14px"
            >店铺评分：</label
          >
          <el-rate
              ...
              <span class="infoshow">
                <el-descriptions class="margin-top" :column="3" border>
                  ...
                  <el-descriptions-item>
                    ...
                    <el-checkbox-group :max="1" v-model="taste.i" :min="0">
                      <el-checkbox
                        :label="dishes.taste1"
                        border
                  ...
                  <el-form-item>
                    <el-button
                      ...
                      >+</el-button
                    >
                    <el-button class="reduce_button" @click="reducedishes(i)"
                      >-</el-button
                    >
                  </el-form-item>
                </el-descriptions>
    ...
    <div class="footer">
      <div class="cart-bottom">
        <span class="cart-bottom-span"
          >已选择<span class="cart-total-num">{{ cart_dict.totalnum }}</span
          >件商品</span
        >
        <span class="cart-bottom-span"
          >总计：<span class="cart-total-price">{{
            cart_dict.totalprice
          }}</span></span
        >
...
export default {
  ...
  mounted() {
    ...
    this.shangjiaid = this.$route.query.shangjiaid;
