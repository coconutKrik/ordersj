    ...
    <div>
       <el-form :model="dataruleForm" status-icon :rules="rules" ref="dataruleForm" label-width="100px" class="demo-dataruleForm">
           <el-form-item label="菜品名" prop="dishesname">
               <el-input  v-model="dataruleForm.dishesname" autocomplete="off"></el-input>
           </el-form-item>
           ...
           <el-form-item>
               <el-button class="submit_button" type="success" @click="submitForm('dataruleForm')">增加菜品</el-button>
