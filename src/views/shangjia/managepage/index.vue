  ...
  <el-container style="height: 100%; border: 1px solid #eee">
    <el-aside width="15%" style="background-color: white">
      <el-menu class="el-menu-vertical-demo">
        <el-submenu index="1">
          <template slot="title"
            ><i class="el-icon-s-shop"></i>菜品管理</template
          >

          <el-menu-item index="1-1"
            ><a href="/shangjiaindex/dishesshow"
              ><span>菜品浏览</span></a
            ></el-menu-item
          >
          <el-menu-item index="1-2"
            ><a href="/shangjiaindex/dishesadd"
              ><span>菜品增加</span></a
            ></el-menu-item
          >
          <el-menu-item index="1-3"
            ><a href="/shangjiaindex/disheschange"
              ><span>菜品修改</span></a
            ></el-menu-item
          >
        </el-submenu>
    ...
    <el-container>
      <el-header style="text-align: right; font-size: 12px">
        ...
        >
          <el-menu-item
            ><a href="/shangjiaindex"
              ><span style="width: 100%; height: 100%">商家首页</span></a
            ></el-menu-item
          >
          <el-submenu
            index="2"
            style="display: flex; margin-right: 0px; float: right"
          >
            <template slot="title">
              <div>
                <i class="el-icon-user-solid" style="display: inline-block"></i>
                <span style="display: inline-block">{{ shangjianame }} </span>
              </div>
            </template>
            <el-menu-item index="1-1"
