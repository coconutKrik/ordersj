<template>
    <el-form :model="registerruleForm" status-icon :rules="rules" ref="registerruleForm" label-width="100px" class="demo-registerruleForm" >
      ...
      <el-form-item label="地区" prop="districtid" style="text-align: left;">
        <el-select v-model="registerruleForm.provinceid" placeholder="省级行政区" filterable  @change="loadcity($event)" style=" margin-right:5%;width: 30%;display: inline-block;">
          <el-option
        ...
        <el-select v-model="registerruleForm.cityid" placeholder="所在市" filterable @change="loaddistrict($event)"  style="margin-right:5%;width: 30%;display: inline-block;">
          <el-option
        ...
        <el-select v-model="registerruleForm.districtid" placeholder="所在区/县" filterable  style="width:30%;display: inline-block;">
          <el-option
  ...
  export default {
    data() {
      ...
      return {
        ...
        rules: {
          ...
          marketname:[{
            required:true,validator:checkmarketname,trigger:"blur"
          }],
          place:[{
    ...
    mounted(){
      ...
      .then(res=>{
        if(res.data.code==0){
          this.provicnes=res.data.provicne_list;
        }else{
